    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('active', models.BooleanField(default=True)),
                ('all_review', models.ManyToManyField(blank=True, to='cinema_feedback.review')),
            ],
        ),
        migrations.CreateModel(
            name='CinemaArrangeSlot',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ...
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('active', models.BooleanField(default=True)),
                ('cinema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='managecinema.cinema')),
                ('duration_slot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='managecinema.moviedurationslot')),
            ],
        ),
    ]
