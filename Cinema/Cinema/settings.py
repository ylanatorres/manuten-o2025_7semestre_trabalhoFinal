...
# --- CORREÇÃO DE SEGURANÇA (SONAR): Chaves lidas do ambiente ---
# A chave real não está mais no código. 
# Se a variável de ambiente não existir, usa uma chave insegura APENAS para dev.
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-change-me-please')

# SECURITY WARNING: don't run with debug turned on in production!
# Transforma a string 'False' do ambiente em booleano, ou usa True como padrão local
